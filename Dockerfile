...
RUN /usr/local/bin/install-plugins.sh workflow-aggregator job-dsl git build-flow-plugin docker-build-publish amazon-ecr amazon-ecs docker-workflow s3 nodejs bitbucket 
